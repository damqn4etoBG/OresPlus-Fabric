...
public enum ModArmorMaterial implements ArmorMaterial {
    RUBY("ruby", 27, new int[]{3, 5, 9, 3}, 25, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND,
            0.0F, 0.0F, () -> {
        return Ingredient.ofItems(ModItems.RUBY);
    }),

    ENPOWERED_OBXIDIAN("enpowered_obxidian", 50, new int[]{6, 10, 18, 6}, 25, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            2.0F, 1.0F, () -> {
        return Ingredient.ofItems(ModItems.ENPOWRED_OBXIDIAN_INGOT);
    });
